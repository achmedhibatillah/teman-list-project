...
<form action="<?= base_url('simpan-teman-kerja') ?>" method="post">
    <div class="form-group mb-3">
        <label for="nama_teman_kerja">Nama Teman Kerja</label>
        <input type="text" id="nama_teman_kerja" name="nama_teman_kerja" class="form-control" required>
    </div>
    <div class="form-group mb-3">
