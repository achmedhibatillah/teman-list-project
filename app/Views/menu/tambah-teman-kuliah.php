...
<form action="<?= base_url('simpan-teman-kuliah') ?>" method="post">
    <div class="form-group mb-3">
        <label for="nama_teman_sma">Nama Teman Kuliah</label>
        <input type="text" id="nama_teman_kuliah" name="nama_teman_kuliah" class="form-control" required>
    </div>
    <div class="form-group mb-3">
