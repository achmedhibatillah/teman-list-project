...
<form action="<?= base_url('simpan-teman-sd') ?>" method="post">
    <div class="form-group mb-3">
        <label for="nama_teman_sd">Nama Teman SD</label>
        <input type="text" id="nama_teman_sd" name="nama_teman_sd" class="form-control" required>
    </div>
    <div class="form-group mb-3">
