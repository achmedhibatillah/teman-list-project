...
<form action="<?= base_url('simpan-teman-sma') ?>" method="post">
    <div class="form-group mb-3">
        <label for="nama_teman_sma">Nama Teman SMA</label>
        <input type="text" id="nama_teman_sma" name="nama_teman_sma" class="form-control" required>
    </div>
    <div class="form-group mb-3">
